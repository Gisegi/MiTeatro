...
class ListaObras : Fragment() {
    ...
    lateinit var recObras : RecyclerView
    ...
    override fun onCreateView(
        ...
        v = inflater.inflate(R.layout.fragment_lista_obras, container, false)

        recObras = v.findViewById(R.id.recObrasFav)
        btnAdd = v.findViewById(R.id.floatbtnAdd)
